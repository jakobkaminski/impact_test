...
Due to this complex interactions and long intervals (3-6 weeks) between outpatient visits and side-effects that occur at shorter time periods (within hours and after a few days) it is hard to disentanle cause and consequences of symptom and side-effects when starting medication.  
...
Day by day smartphone based symptom assesment and a visualisation of the course for the symptomsmight allow a better evaluation of sympotms at a follow-up appointment. 

## Impact for EMA data
Test of impact package for use in n of 1 experiment with electronic momentary assesment. We here created a dummy time series data of n of 1 experiment of two symptoms that were tracked every day on a scale from 0 to 3:
...
For a statistical evaluation of the medication effect we looked at the period from medication start to four weeks therafter. With the impact package we are able to infere a quantitative estimate of the counterfactual.
